...
const weekData: { day: string; concentration: number; mood: number; taken: boolean }[] = [];
...
export default function Records() {
  ...
  const record = mockRecords[selectedDate] ?? null;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {record ? (
            ...
            <div className="bg-white border-2 border-dashed border-[#6B8E23] rounded-2xl p-12 text-center">
              <Calendar className="w-12 h-12 text-[#6c6f72] mx-auto mb-3" />
              <p className="text-[#6c6f72]">이 날의 기록이 없습니다</p>
            </div>
          )}
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white border-2 border-[#6B8E23] p-5 rounded-2xl">
            ...
            {weekData.length === 0 ? (
              <p className="text-sm text-[#6c6f72] text-center py-4">기록된 데이터가 없습니다</p>
            ) : (
