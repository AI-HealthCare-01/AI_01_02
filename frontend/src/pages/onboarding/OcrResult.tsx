...
function MedRow({
  ...
  const inputCls = (low: boolean, disabled: boolean) =>
    `border rounded-xl px-3 py-2 text-sm w-full focus:outline-none focus:ring-2 focus:ring-green-500 ${disabled ? "bg-gray-50 text-gray-500 cursor-default" : low ? "border-amber-400 bg-amber-50" : "border-gray-200 bg-white"
    }`;
