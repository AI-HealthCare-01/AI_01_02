...
export default function Medications() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-5xl mx-auto">
      ...
      <p className="text-sm text-gray-400 mb-5">현재 복용 중인 약물과 복약 현황을 확인하세요.</p>
      ...
      <div className="flex flex-col lg:flex-row gap-5">
        ...
        <div className="w-full lg:w-64 shrink-0 space-y-3">
          ...
          <div className="bg-white border border-gray-200 rounded-xl px-5 py-4 flex items-center justify-between">
            <span className="text-sm font-medium text-gray-700">복약률</span>
        ...
        <div className="px-5 pb-5 border-t border-gray-100">
          <div className="flex gap-6 mt-4">
            <div className="text-center">
              <p className="text-xs text-gray-400 mb-1">남은 약 갯수</p>
              <p className="text-sm font-bold text-gray-800">
                {estimatedRemaining != null ? `${estimatedRemaining}정` : "—"}
              </p>
            </div>
            <div className="text-center">
              <p className="text-xs text-gray-400 mb-1">준수율</p>
          ...
          {r.dose && (
            <p className="text-xs text-gray-400 mt-3">용량: {r.dose}</p>
          )}
